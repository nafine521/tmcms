...
function lib_channel(&$ctag,&$refObj)
{
    ...
    if($type=='top')
{
	$sql = "Select id,typename,typeimg,typepic,typeico,typestitle,typetitle,typedir,isdefault,ispart,defaultname,namerule2,moresite,siteurl,sitepath,description
