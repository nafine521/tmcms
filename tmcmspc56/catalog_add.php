...
else if($dopost=='savequick')
{
    ...
    $queryTemplate = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typetitle,typedir,typeimg,typepic,typeico,typestitle,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('~reid~','~topid~','~rank~','~typename~','~typedir~','~typeimg~','~typepic~','~typeico~','~typestitle~','~typetitle~','$isdefault','$defaultname','$issend','$channeltype',
...
else if($dopost=='save')
{
    ...
    $in_query = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typedir,typeimg,typepic,typeico,typestitle,typetitle,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('$reid','$topid','$sortrank','$typename','$typedir','$typeimg','$typepic','$typeico','$typestitle','$typetitle','$isdefault','$defaultname','$issend','$channeltype',
